...
var EndpointLink = (function () {
    ...
    EndpointLink.prototype.init = function () {
        this.servers = this.specMgr.getServers(this.optionsService.options.hideHostname);
    };
