...
RequestSamples.decorators = [
    { type: Component, args: [{
                ...
                styles: [':host{overflow:hidden;display:block}.action-buttons{opacity:0;transition:opacity .3s ease;transform:translateY(100%);z-index:3;position:relative;height:2em;line-height:2em;padding-right:10px;text-align:right;margin-top:-1em}.action-buttons>span>a{padding:2px 10px;color:#fff;cursor:pointer}.action-buttons>span>a:hover{background-color:#304757}.code-sample:hover>.action-buttons{opacity:1}header{font-family:Montserrat;font-size:.929em;margin:20px 0 0;color:#81a2b9;text-transform:uppercase;font-weight:400}:host /deep/>tabs>ul li{font-family:Montserrat;font-size:.9em;border-radius:2px;margin:2px 0;padding:3px 10px 2px;line-height:16px;color:#81a2b9}:host /deep/>tabs>ul li:hover{background-color:rgba(255,255,255,.1);color:#fff}:host /deep/>tabs>ul li.active{background-color:#fff;color:#151f26}:host /deep/ tabs ul{padding-top:10px}.code-sample pre{word-break:break-all;word-wrap:break-word;white-space:pre-wrap;margin-top:0;overflow-x:auto;padding:20px;border-radius:4px;background-color:#222d32;margin-bottom:36px}'],
