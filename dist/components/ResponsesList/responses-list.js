...
ResponsesList.decorators = [
    { type: Component, args: [{
                ...
                styles: [':host{display:block}.header-name,.header-type{display:inline-block;font-weight:700}.responses-list-header{font-size:18px;padding:.2em 0;margin:3em 0 1.1em;color:#253137;font-weight:400}:host .zippy-title{font-family:Montserrat,sans-serif}.header-type{color:#999;padding-left:.5em}header{font-size:14px;font-weight:700;text-transform:uppercase;margin-bottom:15px}header:not(:first-child){margin-top:15px;margin-bottom:0}.header{margin-bottom:10px}.header-range{position:relative;top:1px;margin-right:6px;margin-left:6px;border-radius:2px;background-color:rgba(0,51,160,.1);padding:0 4px;color:rgba(0,51,160,.7)}.header-type.array::before{content:"Array of ";color:#151f26;font-weight:300}'],
