...
var SchemaSample = (function (_super) {
    ...
    SchemaSample.prototype.init = function () {
        ...
        var xmlLikeSample = base.examples && getXmlLikeSample(base.examples);
        if (xmlLikeSample) {
...
SchemaSample.decorators = [
    { type: Component, args: [{
                ...
                template: '<ng-template #jsonSnippet><div class="snippet"><pre *ngIf="sample == undefined"> Sample unavailable </pre><div class="action-buttons"><span copy-button [copyText]="sample" class="hint--top-left hint--inversed"><a>Copy</a> </span><span><a *ngIf="enableButtons" (click)="expandAll()">Expand all</a> </span><span><a *ngIf="enableButtons" (click)="collapseAll()">Collapse all</a></span></div><pre [innerHtml]="sample | jsonFormatter"></pre></div></ng-template><tabs *ngIf="xmlSample; else jsonSnippet"><tab tabTitle="JSON"><ng-container *ngTemplateOutlet="jsonSnippet"></ng-container></tab><tab tabTitle="XML" *ngIf="xmlSample"><div class="snippet"><div class="action-buttons"><span copy-button [copyText]="xmlSample" class="hint--top-left hint--inversed"><a>Copy</a></span></div><pre class="xml-sample" [innerHtml]="xmlSample | prism:\'xml\'"></pre></div></tab></tabs>',
                styles: ['@charset "UTF-8";:host{display:block}:host /deep/ tabs{margin-top:1em}:host /deep/ tabs>ul{margin:0;padding:0}:host /deep/ tabs>ul>li{padding:2px 10px;display:inline-block;background:#131a1d;border-bottom:1px solid trasparent;color:#81a2b9}:host /deep/ tabs>ul>li.active{color:#fff;border-bottom:1px solid #81a2b9}:host /deep/ tabs .action-buttons{margin-top:-2em}pre{background-color:transparent;padding:0;margin:0;clear:both;position:relative;color:#fff;border:none}.action-buttons{opacity:0;transition:opacity .3s ease;transform:translateY(100%);z-index:3;position:relative;height:2em;line-height:2em;padding-right:10px;text-align:right;margin-top:-1em}.action-buttons>span>a{padding:2px 10px;color:#fff;cursor:pointer}.action-buttons>span>a:hover{background-color:#304757}.snippet:hover .action-buttons{opacity:1}:host /deep/ .type-null{color:gray}:host /deep/ .type-boolean{color:#b22222}:host /deep/ .type-number{color:#4A8BB3}:host /deep/ .type-string{color:#66B16E}:host /deep/ .callback-function{color:gray}:host /deep/ .collapser:after{content:"-";cursor:pointer}:host /deep/ .collapsed>.collapser:after{content:"+";cursor:pointer}:host /deep/ .ellipsis:after{content:" … "}:host /deep/ .collapsible{margin-left:2em}:host /deep/ .hoverable{border-radius:2px;padding:1px 2px}:host /deep/ .hovered{background-color:#ebeef9}:host /deep/ .collapser{padding-right:6px;padding-left:6px}:host /deep/ .redoc-json,:host /deep/ .xml-sample{overflow-x:auto;padding:20px;border-radius:4px;background-color:#111a1f;margin-bottom:36px}:host /deep/ .redoc-json ul,:host /deep/ ul{list-style-type:none;padding:0;margin:0 0 0 26px}:host /deep/ li{position:relative;display:block}:host /deep/ .hoverable{transition:background-color .2s ease-out 0s;-webkit-transition:background-color .2s ease-out 0s;display:inline-block}:host /deep/ .hovered{transition-delay:.2s;-webkit-transition-delay:.2s}:host /deep/ .selected{outline-width:1px;outline-style:dotted}:host /deep/ .collapsed>.collapsible{display:none}:host /deep/ .ellipsis{display:none}:host /deep/ .collapsed>.ellipsis{display:inherit}:host /deep/ .collapser{position:absolute;top:1px;left:-1.5em;cursor:default;user-select:none;-webkit-user-select:none}:host /deep/ .redoc-json>.collapser{display:none}'],
