...
SecurityDefinitions.decorators = [
    { type: Component, args: [{
                ...
                styles: [':host{display:block}.security-definition:not(:last-of-type){border-bottom:1px solid rgba(21,31,38,.3);padding-bottom:20px}:host h2{padding-top:40px}h3{margin:1em 0;font-size:1em}:host .security-details,:host .security-scopes-details{margin-top:20px}table.details td,table.details th{font-weight:700;width:200px;max-width:50%}table.details th{text-align:left;padding:6px;text-transform:capitalize;font-weight:400}'],
