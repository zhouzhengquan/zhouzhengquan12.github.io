...
var SearchService = (function () {
    ...
    SearchService.prototype.search = function (q) {
        var _this = this;
        var items = {};
        var res = this.idx.search(q).map(function (res) {
            items[res.menuId] = res;
            return _this.store[res.ref];
        });
    ...
    SearchService.prototype.index = function (element) {
        ...
        if (this.store[element.pointer])
            return;
        this.idx.add(element);
        this.store[element.pointer] = element;
    };
