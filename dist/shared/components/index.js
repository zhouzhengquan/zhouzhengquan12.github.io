...
import { CodeflaskComponent } from './CodeFlask/code-flask.component';
export var REDOC_COMMON_DIRECTIVES = [
    CodeflaskComponent, PerfectScrollbar, DropDown, StickySidebar, Tabs, Tab, Zippy, CopyButton, SelectOnClick, DynamicNg2Viewer, DynamicNg2Wrapper, LazyFor
];
