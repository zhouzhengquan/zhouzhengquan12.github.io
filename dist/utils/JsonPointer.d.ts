...
export declare class JsonPointer {
     ...
     */
    static baseName(pointer: any, level?: number): any;
    /**
     ...
     */
    static dirName(pointer: any, level?: number): any;
    /**
    ...
    */
    ...
    static compile(tokens: string[]): any;
    static escape(pointer: string): any;
}
